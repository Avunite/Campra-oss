		...
		<div class="main">
			...
			<footer class="footer">
				<div class="info">
					...
					<MkA class="campra-for" :to="notePage(appearNote)">
						<Mfm v-if="appearNote.campraFor" :text="appearNote.campraFor" :author="appearNote.user" :i="$i"/>
					</MkA>
				</div>
...
.info .created-at, .info .campra-for {
    display: block;
}
.campra-for {
	//margin-top: 4px;
