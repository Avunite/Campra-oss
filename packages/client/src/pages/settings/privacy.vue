...
<div class="_formRoot">
	...
	<FormSection>
		...
		<FormSwitch v-model="campraForToggle" class="_formBlock" @update:modelValue="save()">{{ i18n.ts.campraForToggle }}</FormSwitch>
...
let campraForToggle = $computed(defaultStore.makeGetterSetter('campraForToggle'));
