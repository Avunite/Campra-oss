...
export const routes = [{
	...
	path: '/verify-school-admin/:token',
	component: page(() => import('./pages/verify-school-admin.vue')),
}, {
	...
	path: '/about-campra',
	component: page(() => import('./pages/about-campra.vue')),
}, {
	path: '/theme-editor',
	...
	path: '/school-admin',
	component: ($i && $i.isSchoolAdmin) ? page(() => import('./pages/school-admin/index.vue')) : page(() => import('./pages/not-found.vue')),
	children: [{
		path: '/dashboard',
		name: 'school-admin-dashboard',
		component: page(() => import('./pages/school-admin/dashboard.vue')),
	}, {
		path: '/students',
		name: 'school-admin-students', 
		component: page(() => import('./pages/school-admin/students.vue')),
	}, {
		path: '/teachers',
		name: 'school-admin-teachers',
		component: page(() => import('./pages/school-admin/teachers.vue')),
	}, {
		path: '/profile',
		name: 'school-admin-profile',
		component: page(() => import('./pages/school-admin/profile.vue')),
	}, {
		path: '/billing',
		name: 'school-admin-billing',
		component: page(() => import('./pages/school-admin/billing.vue')),
	}, {
		path: '/moderation',
		name: 'school-admin-moderation',
		component: page(() => import('./pages/school-admin/moderation.vue')),
	}, {
		path: '/whitelist',
		name: 'school-admin-whitelist',
		component: page(() => import('./pages/school-admin/whitelist.vue')),
	}, {
		path: '/import-students',
		name: 'school-admin-import',
		component: page(() => import('./pages/school-admin/import-students.vue')),
	}, {
		path: '/settings',
		name: 'school-admin-settings',
		component: page(() => import('./pages/school-admin/settings.vue')),
	}, {
		path: '/',
		component: page(() => import('./pages/_empty_.vue')),
	}]
	...
	children: [{
		...
		path: '/schools',
		name: 'schools',
		component: page(() => import('./pages/admin/schools.vue')),
	}, {
		path: '/school-management',
		name: 'school-management',
		component: page(() => import('./pages/admin/school-management.vue')),
	}, {
		path: '/email-settings',
		name: 'email-settings',
