...
<div class="mvcprjjd" :class="{ iconOnly }">
	<div class="body">
		...
		<div class="middle">
			...
			<MkA v-if="$i.isSchoolAdmin && $i.adminForSchoolId" v-click-anime v-tooltip.noDelay.right="i18n.ts.schoolAdministration" class="item _button" active-class="active" to="/school-admin">
				<i class="icon ph-graduation-cap-bold ph-lg ph-fw ph-lg"></i><span class="text">{{ i18n.ts.schoolAdministration }}</span>
			</MkA>
