...
import { ChannelInvitation } from './channel-invitation.js';
...
export class Notification {
	...
	public channelInvitationId: ChannelInvitation['id'] | null;

	@ManyToOne(type => ChannelInvitation, {
		onDelete: 'CASCADE',
	})
	@JoinColumn()
	public channelInvitation: ChannelInvitation | null;
