...
export class Meta {
	...
	@Column('varchar', {
		length: 512, array: true, default: '{/featured,/channels,/explore,/pages,/about-campra}',
	})
	...
	public automodAccountId: User['id'] | null;

	@ManyToOne(type => User, {
		onDelete: 'SET NULL',
	})
	@JoinColumn()
	public automodAccount: User | null;
	...
	public enableContentModeration: boolean;

	@Column('varchar', {
		length: 256,
		nullable: true,
	})
	public iffyApiKey: string | null;

	@Column('varchar', {
		length: 256,
		nullable: true,
	})
	public iffyApiUrl: string | null;

	@Column('varchar', {
		length: 256,
		nullable: true,
	})
	public iffyWebhookSecret: string | null;

	@Column('varchar', {
		length: 16,
		default: 'medium',
	})
	public iffyConfidenceThreshold: 'low' | 'medium' | 'high';

	@Column('boolean', {
		default: true,
	})
	public autoHideInappropriateContent: boolean;

	@Column('boolean', {
		default: false,
	})
	public enableSchoolContentModeration: boolean;

	@Column('boolean', {
		default: true,
	})
	public enableSchoolProximityBoost: boolean;
	...
	@Column('varchar', {
		length: 512,
		default: 'https://github.com/Avunite/Campra',
		nullable: false,
	})
	...
	@Column('varchar', {
		length: 512,
		default: 'https://campra.app/@Avunite',
		nullable: true,
	})
	...
	public stripeSchoolPriceId: string | null;
