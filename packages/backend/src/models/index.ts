...
import { MessagingMessageReaction } from './entities/messaging-message-reaction.js';
import { School } from './entities/school.js';
import { SchoolDomain } from './entities/school-domain.js';
import { SchoolBilling } from './entities/school-billing.js';
import { CampusBlock } from './entities/campus-block.js';
import { GraduatedStudent } from './entities/graduated-student.js';
import { ContentFlag } from './entities/content-flag.js';
import { ModerationEscalation } from './entities/moderation-escalation.js';
import { PricingHistory } from './entities/pricing-history.js';
import { StripeCustomer } from './entities/stripe-customer.js';
import { SchoolRepository } from './repositories/school.js';
import { SchoolAdminVerification } from './entities/school-admin-verification.js';
import { CSVImportLog } from './entities/csv-import-log.js';
import { EmailWhitelist } from './entities/email-whitelist.js';
import { ChannelRole } from './entities/channel-role.js';
import { ChannelPermission } from './entities/channel-permission.js';
import { ChannelMemberRole } from './entities/channel-member-role.js';
import { ChannelUserFlair } from './entities/channel-user-flair.js';
import { ChannelPostFlair } from './entities/channel-post-flair.js';
import { UserChannelFlair } from './entities/user-channel-flair.js';
import { NotePostFlair } from './entities/note-post-flair.js';
import { ChannelInvitation } from './entities/channel-invitation.js';
import { ChannelInviteRequest } from './entities/channel-invite-request.js';
import { ChannelInvitationRepository } from './repositories/channel-invitation.js';
import { LMSSyncLog } from './entities/lms-sync-log.js';
import { RegistrationWaitlist } from './entities/registration-waitlist.js';
...
export const Schools = (SchoolRepository);
export const SchoolDomains = db.getRepository(SchoolDomain);
export const SchoolBillings = db.getRepository(SchoolBilling);
export const CampusBlocks = db.getRepository(CampusBlock);
export const GraduatedStudents = db.getRepository(GraduatedStudent);
export const ContentFlags = db.getRepository(ContentFlag);
export const ModerationEscalations = db.getRepository(ModerationEscalation);
export const PricingHistories = db.getRepository(PricingHistory);
export const StripeCustomers = db.getRepository(StripeCustomer);
export const SchoolAdminVerifications = db.getRepository(SchoolAdminVerification);
export const CSVImportLogs = db.getRepository(CSVImportLog);
export const EmailWhitelists = db.getRepository(EmailWhitelist);
export const ChannelRoles = db.getRepository(ChannelRole);
export const ChannelPermissions = db.getRepository(ChannelPermission);
export const ChannelMemberRoles = db.getRepository(ChannelMemberRole);
export const ChannelUserFlairs = db.getRepository(ChannelUserFlair);
export const ChannelPostFlairs = db.getRepository(ChannelPostFlair);
export const UserChannelFlairs = db.getRepository(UserChannelFlair);
export const NotePostFlairs = db.getRepository(NotePostFlair);
export const ChannelInvitations = (ChannelInvitationRepository);
export const ChannelInviteRequests = db.getRepository(ChannelInviteRequest);
export const LMSSyncLogs = db.getRepository(LMSSyncLog);
export const RegistrationWaitlists = db.getRepository(RegistrationWaitlist);
