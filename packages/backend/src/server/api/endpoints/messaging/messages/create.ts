...
export const paramDef = {
	...
	properties: {
		...
		replyId: { type: 'string', format: 'campra:id' },
	},
	anyOf: [
		{
			properties: {
		...
		{
			properties: {
				groupId: { type: 'string', format: 'campra:id' },
			},
			required: ['groupId'],
		},
	],
...
export default define(meta, paramDef, async (ps, user) => {
	...
	return await createMessage(user, recipientUser, recipientGroup, ps.text, file, ps.replyId);
});
