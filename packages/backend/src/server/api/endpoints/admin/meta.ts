...
export default define(meta, paramDef, async (ps, me) => {
	...
	return {
		...
		stripe_webhook_secret: instance.stripeWebhookSecret,
		stripeSchoolPriceId: instance.stripeSchoolPriceId,
		// Content moderation (iffy) settings
		enableContentModeration: instance.enableContentModeration,
		iffyApiKey: instance.iffyApiKey,
		iffyApiUrl: instance.iffyApiUrl,
		iffyWebhookSecret: instance.iffyWebhookSecret,
		...
		enableSchoolContentModeration: instance.enableSchoolContentModeration,
		automodAccountId: instance.automodAccountId,
	};
});
