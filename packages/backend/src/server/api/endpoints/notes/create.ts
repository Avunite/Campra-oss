...
export const paramDef = {
	...
	properties: {
		...
		campraFor: { type: 'string', maxLength: 256, nullable: true },
		...
		fileIds: {
			...
			minItems: 1,
			maxItems: 16,
			items: { type: 'string', format: 'campra:id' },
		},
		mediaIds: {
			deprecated: true,
		...
		replyId: { type: 'string', format: 'campra:id', nullable: true },
		renoteId: { type: 'string', format: 'campra:id', nullable: true },
		channelId: { type: 'string', format: 'campra:id', nullable: true },
		poll: {
			type: 'object',
			nullable: true,
			properties: {
...
export default define(meta, paramDef, async (ps, user) => {
	...
	const note = await create(user, {
		...
		campraFor: ps.campraFor || undefined,
		reply,
		renote,
		cw: ps.cw,
