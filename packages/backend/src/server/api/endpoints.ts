...
import * as ep___admin_schools_manageSubscription from './endpoints/admin/schools/manage-subscription.js';
import * as ep___admin_schools_list from './endpoints/admin/schools/list.js';
import * as ep___admin_schools_set_billing_rate from './endpoints/admin/schools/set-billing-rate.js';
import * as ep___admin_schools_set_student_cap from './endpoints/admin/schools/set-student-cap.js';
import * as ep___admin_schools_delete_school from './endpoints/admin/schools/delete-school.js';
import * as ep___admin_schools_dashboard_data from './endpoints/admin/schools/dashboard-data.js';
import * as ep___admin_schools_suspensionReport from './endpoints/admin/schools/suspension-report.js';
import * as ep___admin_schools_manualAccessControl from './endpoints/admin/schools/manual-access-control.js';
...
import * as ep___platform_admin_create_school from './endpoints/platform-admin/create-school.js';
import * as ep___platform_admin_list_schools from './endpoints/platform-admin/list-schools.js';
import * as ep___platform_admin_update_school from './endpoints/platform-admin/update-school.js';
import * as ep___platform_admin_create_school_admin from './endpoints/platform-admin/create-school-admin.js';
import * as ep___platform_admin_list_school_admins from './endpoints/platform-admin/list-school-admins.js';
import * as ep___platform_admin_remove_school_admin from './endpoints/platform-admin/remove-school-admin.js';
import * as ep___platform_admin_stats from './endpoints/platform-admin/stats.js';
import * as ep___platform_admin_refresh_school_status from './endpoints/platform-admin/refresh-school-status.js';
import * as ep___platform_admin_mark_school_demo from './endpoints/platform-admin/mark-school-demo.js';
import * as ep___platform_admin_mark_user_demo from './endpoints/platform-admin/mark-user-demo.js';
import * as ep___platform_admin_create_demo_school from './endpoints/platform-admin/create-demo-school.js';
import * as ep___schools_check_access from './endpoints/schools/check-access.js';
import * as ep___schools_show from './endpoints/schools/show.js';
import * as ep___schools_billing_info from './endpoints/schools/billing-info.js';
import * as ep___schools_students from './endpoints/schools/students.js';
import * as ep___schools_update_profile from './endpoints/schools/update-profile.js';
import * as ep___schools_student_stats from './endpoints/schools/student-stats.js';
import * as ep___schools_analytics from './endpoints/schools/analytics.js';
import * as ep___schools_moderation_stats from './endpoints/schools/moderation-stats.js';
import * as ep___schools_unhide_content from './endpoints/schools/unhide-content.js';
import * as ep___schools_invoices from './endpoints/schools/invoices.js';
import * as ep___schools_content_flags from './endpoints/schools/content-flags.js';
import * as ep___schools_review_content from './endpoints/schools/review-content.js';
import * as ep___schools_cap_status from './endpoints/schools/cap-status.js';
import * as ep___schools_request_cap_increase from './endpoints/schools/request-cap-increase.js';
import * as ep___schools_set_student_cap from './endpoints/schools/set-student-cap.js';
import * as ep___schools_verify_admin from './endpoints/schools/verify-admin.js';
import * as ep___schools_update_settings from './endpoints/schools/update-settings.js';
import * as ep___schools_get_settings from './endpoints/schools/get-settings.js';
import * as ep___schools_import_students from './endpoints/schools/import-students.js';
import * as ep___schools_import_preview from './endpoints/schools/import-preview.js';
import * as ep___schools_import_summary from './endpoints/schools/import-summary.js';
import * as ep___schools_create_teacher from './endpoints/schools/create-teacher.js';
import * as ep___schools_invite_admin from './endpoints/schools/invite-admin.js';
import * as ep___schools_list_teachers from './endpoints/schools/list-teachers.js';
import * as ep___schools_timeline from './endpoints/schools/timeline.js';
import * as ep___schools_manage_whitelist from './endpoints/schools/manage-whitelist.js';
import * as ep___schools_whitelist_from_csv from './endpoints/schools/whitelist-from-csv.js';
import * as ep___schools_lms_connect from './endpoints/schools/lms/connect.js';
import * as ep___schools_lms_disconnect from './endpoints/schools/lms/disconnect.js';
import * as ep___schools_lms_get_oauth_url from './endpoints/schools/lms/get-oauth-url.js';
import * as ep___schools_lms_oauth_callback from './endpoints/schools/lms/oauth-callback.js';
import * as ep___schools_lms_status from './endpoints/schools/lms/status.js';
import * as ep___schools_lms_sync from './endpoints/schools/lms/sync.js';
import * as ep___platform_admin_create_school_with_admin from './endpoints/platform-admin/create-school-with-admin.js';
import * as ep___stripe_create_school_subscription from './endpoints/stripe/create-school-subscription.js';
import * as ep___stripe_setup_intent from './endpoints/stripe/setup-intent.js';
...
import * as ep___admin_cleanup_duplicate_customers from './endpoints/admin/stripe/cleanup-duplicate-customers.js';
...
import * as ep___stripe_school_price from './endpoints/stripe/school-price.js';
import * as ep___stripe_school_pricing from './endpoints/stripe/school-pricing.js';
import * as ep___stripe_get_price from './endpoints/stripe/get-price.js';
import * as ep___stripe_config_status from './endpoints/stripe/config-status.js';
import * as ep___stripe_create_setup_intent from './endpoints/stripe/create-setup-intent.js';
import * as ep___stripe_attach_payment_method from './endpoints/stripe/attach-payment-method.js';
import * as ep___iffy_webhook from './endpoints/iffy/webhook.js';
...
import * as ep___i_changeRequiredPassword from './endpoints/i/change-required-password.js';
...
import * as ep___notes_schoolTimeline from './endpoints/notes/school-timeline.js';
...
import * as ep___school_deletePost from './endpoints/school/delete-post.js';
import * as ep___school_suspendStudent from './endpoints/school/suspend-student.js';
import * as ep___school_unsuspendStudent from './endpoints/school/unsuspend-student.js';
import * as ep___school_students from './endpoints/school/students.js';
import * as ep___school_deleteStudent from './endpoints/school/delete-student.js';
import * as ep___school_setGraduationDate from './endpoints/school/set-graduation-date.js';
import * as ep___school_batchSetGraduationDates from './endpoints/school/batch-set-graduation-dates.js';
import * as ep___school_batchSetGrades from './endpoints/school/batch-set-grades.js';
import * as ep___school_setStudentUsername from './endpoints/school/set-student-username.js';
import * as ep___school_moderationQueue from './endpoints/school/moderation-queue.js';
import * as ep___school_reviewContent from './endpoints/school/review-content.js';
import * as ep___school_adminDashboard from './endpoints/school/admin-dashboard.js';
import * as ep___i_validateUsername from './endpoints/i/validate-username.js';
import * as ep___fetchRss from './endpoints/fetch-rss.js';
import * as ep___geocoding_addressToCoordinates from './endpoints/geocoding/address-to-coordinates.js';
...
const eps = [
	...
	['admin/schools/manage-subscription', ep___admin_schools_manageSubscription],
	['admin/schools/list', ep___admin_schools_list],
	['admin/schools/set-billing-rate', ep___admin_schools_set_billing_rate],
	['admin/schools/set-student-cap', ep___admin_schools_set_student_cap],
	['admin/schools/delete-school', ep___admin_schools_delete_school],
	['admin/schools/dashboard-data', ep___admin_schools_dashboard_data],
	['admin/schools/suspension-report', ep___admin_schools_suspensionReport],
	['admin/schools/manual-access-control', ep___admin_schools_manualAccessControl],
	...
	['admin/cleanup-duplicate-customers', ep___admin_cleanup_duplicate_customers],
	...
	['admin/users', ep___admin_showUsers],
	...
	['stripe/checkout', ep___checkout],
	['stripe/manage', ep___stripe_manage],
	['stripe/webhook', ep___stripe_checkout],
	['stripe/prices', ep___stripe_prices],
	['stripe/school-price', ep___stripe_school_price],
	['stripe/school-pricing', ep___stripe_school_pricing],
	['stripe/get-price', ep___stripe_get_price],
	['stripe/config-status', ep___stripe_config_status],
	['stripe/create-setup-intent', ep___stripe_create_setup_intent],
	['stripe/attach-payment-method', ep___stripe_attach_payment_method],
	['stripe/setup-intent', ep___stripe_setup_intent],
	['stripe/create-school-subscription', ep___stripe_create_school_subscription],
	['iffy/webhook', ep___iffy_webhook],
	...
	['i/change-required-password', ep___i_changeRequiredPassword],
	...
	['notes/school-timeline', ep___notes_schoolTimeline],
	...
	['geocoding/address-to-coordinates', ep___geocoding_addressToCoordinates],
	['admin/create-school', ep___platform_admin_create_school],
	['admin/list-schools', ep___platform_admin_list_schools],
	['admin/update-school', ep___platform_admin_update_school],
	['admin/create-school-admin', ep___platform_admin_create_school_admin],
	['admin/list-school-admins', ep___platform_admin_list_school_admins],
	['admin/remove-school-admin', ep___platform_admin_remove_school_admin],
	['admin/create-school-with-admin', ep___platform_admin_create_school_with_admin],
	['admin/refresh-school-status', ep___platform_admin_refresh_school_status],
	['admin/stats', ep___platform_admin_stats],
	['admin/mark-school-demo', ep___platform_admin_mark_school_demo],
	['admin/mark-user-demo', ep___platform_admin_mark_user_demo],
	['admin/create-demo-school', ep___platform_admin_create_demo_school],
	['schools/check-access', ep___schools_check_access],
	['schools/show', ep___schools_show],
	['schools/billing-info', ep___schools_billing_info],
	['schools/students', ep___schools_students],
	['schools/update-profile', ep___schools_update_profile],
	['schools/student-stats', ep___schools_student_stats],
	['schools/analytics', ep___schools_analytics],
	['schools/moderation-stats', ep___schools_moderation_stats],
	['schools/unhide-content', ep___schools_unhide_content],
	['schools/invoices', ep___schools_invoices],
	['schools/content-flags', ep___schools_content_flags],
	['schools/review-content', ep___schools_review_content],
	['schools/cap-status', ep___schools_cap_status],
	['schools/request-cap-increase', ep___schools_request_cap_increase],
	['schools/set-student-cap', ep___schools_set_student_cap],
	['schools/verify-admin', ep___schools_verify_admin],
	['schools/update-settings', ep___schools_update_settings],
	['schools/get-settings', ep___schools_get_settings],
	['schools/import-students', ep___schools_import_students],
	['schools/import-preview', ep___schools_import_preview],
	['schools/import-summary', ep___schools_import_summary],
	['schools/create-teacher', ep___schools_create_teacher],
	['schools/invite-admin', ep___schools_invite_admin],
	['schools/list-teachers', ep___schools_list_teachers],
	['schools/timeline', ep___schools_timeline],
	['schools/manage-whitelist', ep___schools_manage_whitelist],
	['schools/whitelist-from-csv', ep___schools_whitelist_from_csv],
	['schools/lms/connect', ep___schools_lms_connect],
	['schools/lms/disconnect', ep___schools_lms_disconnect],
	['schools/lms/get-oauth-url', ep___schools_lms_get_oauth_url],
	['schools/lms/oauth-callback', ep___schools_lms_oauth_callback],
	['schools/lms/status', ep___schools_lms_status],
	['schools/lms/sync', ep___schools_lms_sync],
	['school/delete-post', ep___school_deletePost],
	['school/suspend-student', ep___school_suspendStudent],
	['school/unsuspend-student', ep___school_unsuspendStudent],
	['school/delete-student', ep___school_deleteStudent],
	['school/students', ep___school_students],
	['school/set-graduation-date', ep___school_setGraduationDate],
	['school/batch-set-graduation-dates', ep___school_batchSetGraduationDates],
	['school/batch-set-grades', ep___school_batchSetGrades],
	['school/set-student-username', ep___school_setStudentUsername],
	['school/moderation-queue', ep___school_moderationQueue],
	['school/review-content', ep___school_reviewContent],
	['school/admin-dashboard', ep___school_adminDashboard],
	['i/validate-username', ep___i_validateUsername],
];
